...
public class BeneficioResourceIntTest {
    ...
    public void setup() {
        ...
        BeneficioResource beneficioResource = new BeneficioResource();
        ReflectionTestUtils.setField(beneficioResource, "beneficioService", beneficioService);
    ...
    public void createBeneficio() throws Exception {
        ...
        restBeneficioMockMvc.perform(post("/api/beneficios")
            ...
            .content(TestUtil.convertObjectToJsonBytes(beneficioDTO)))
    ...
    public void createBeneficioWithExistingId() throws Exception {
        ...
        BeneficioDTO existingBeneficioDTO = beneficioMapper.beneficioToBeneficioDTO(existingBeneficio);

        // An entity with an existing ID cannot be created, so this API call must fail
        restBeneficioMockMvc.perform(post("/api/beneficios")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingBeneficioDTO)))
    ...
    @Test
    @Transactional
    public void checkLocalizacionIsRequired() throws Exception {
        int databaseSizeBeforeTest = beneficioRepository.findAll().size();
        // set the field null
        beneficio.setLocalizacion(null);
    ...
    public void updateBeneficio() throws Exception {
        ...
        BeneficioDTO beneficioDTO = beneficioMapper.beneficioToBeneficioDTO(updatedBeneficio);
