...
public class EntradaResourceIntTest {
    ...
    private static final Integer DEFAULT_KG = 1;
    private static final Integer UPDATED_KG = 2;
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(entradaResource, "entradaRepository", entradaRepository);
